begin;
  ...
  insert into company (symbol, name, sector, industry) values
    ...
    ('AFSD','Aflac Incorporated','Finance','Accident &Health Insurance'),
    ...
    ('AGU','Agrium Inc.','Basic Industries','Agricultural Chemicals'),
    ...
    ('ALEX','Alexander & Baldwin Holdings Inc.','Finance','Real Estate'),
    ...
    ('ALDW','Alon USA Partners LP','Energy','Integrated oil Companies'),
    ...
    ('BETR','Amplify Snack Brands inc.','Consumer Non-Durables','Packaged Foods'),
    ...
    ('NLY^E','Annaly Capital Management Inc','n/a','n/a'),
    ...
    ('ARCX','Arc Logistic Partners LP','Energy','Oil Refining/Marketing'),
    ...
    ('ACP','Avenue Income Credit Strategies Fund','n/a','n/a'),
    ...
    ('BIOA','BioAmber Inc.','Basic Industries','Major Chemicals'),
    ...
    ('BUI','BlackRock Utility and Infrastructure Trust','n/a','n/a'),
    ...
    ('BPY','Brookfield Property Partners L.P.','Finance','Real Estate'),
    ...
    ('BCR','C.R. Bard Inc.','Health Care','Medical/Dental Instruments'),
    ...
    ('CBS','CBS Corporation','Consumer Services','Broadcasting'),
    ...
    ('CEN','Center Coast MLP & Infrastructure Fund','n/a','n/a'),
    ...
    ('XNY','China Xiniya Fashion Limited','Consumer Non-Durables','Apparel'),
    ...
    ('CNXC','CNX Coal Resources LP','Energy','Coal Mining'),
    ('CIE','Cobalt International Energy Inc.','Energy','Oil & Gas Production'),
    ...
    ('CNNX','Cone Midstream Partners LP','Public Utilities','Natural Gas Distribution'),
    ('COP','ConocoPhillips','Energy','Integrated oil Companies'),
    ('CNX','CONSOL Energy Inc.','Energy','Coal Mining'),
    ...
    ('COO','Cooper Companies Inc. (The)','Health Care','Ophthalmic Goods'),
    ...
    ('COR^A.CL','CoreSite Realty Corporation','n/a','n/a'),
    ...
    ('CB','D/B/A Chubb Limited New','Finance','Property-Casualty Insurers'),
    ...
    ('DLPH','Delphi Automotive plc','Capital Goods','Auto Parts:O.E.M.'),
    ...
    ('DTK','Deutsche Bank AG','Finance','Major Banks'),
    ...
    ('DFS^B.CL','Discover Financial Services','n/a','n/a'),
    ...
    ('ETM$','Entercom Communications Corporation','n/a','n/a'),
    ...
    ('ENJ','Entergy New Orleans Inc.','Public Utilities','Power Generation'),
    ('ENO','Entergy New Orleans Inc.','Public Utilities','Power Generation'),
    ...
    ('EQCO','Equity Commonwealth','Consumer Services','Real Estate Investment Trusts'),
    ...
    ('XCO','EXCO Resources NL','Energy','Oil & Gas Production'),
    ...
    ('FPT','Federated Premier Intermediate Municipal Income Fund','n/a','n/a'),
    ...
    ('FGL','Fidelity and Guaranty Life','Finance','Life Insurance'),
    ('FNF','Fidelity National Financial Inc.','Finance','Specialty Insurers'),
    ('FNFV','Fidelity National Financial Inc.','Finance','Specialty Insurers'),
    ...
    ('FIG','Fortress Investment Group LLC','Finance','Investment Managers'),
    ...
    ('FEDU','Four Seasons Education (Cayman) Inc.','n/a','n/a'),
    ...
    ('GEH','General Electric Capital Corporation','Energy','Consumer Electronics/Appliances'),
    ...
    ('GEB','General Electric Company','Energy','Consumer Electronics/Appliances'),
    ...
    ('GIMO','Gigamon Inc.','Technology','EDP Services'),
    ...
    ('GS^I.CL','Goldman Sachs Group Inc. (The)','n/a','n/a'),
    ...
    ('BSMX','Grupo Financiero Santander Mexico S.A. B. de C.V.','Finance','Commercial Banks'),
    ...
    ('HLS','HealthSouth Corporation','Health Care','Hospital/Nursing Management'),
    ...
    ('JPM^D.CL','J P Morgan Chase & Co','n/a','n/a'),
    ...
    ('JMPC','JMP Group LLC','Finance','Investment Bankers/Brokers/Service'),
    ...
    ('KWN.CL','Kennedy-Wilson Holdings Inc.','n/a','n/a'),
    ...
    ('BWG','Legg Mason BW Global Income Opportunities Fund Inc.','n/a','n/a'),
    ...
    ('LXP','Lexington Realty Trust','Consumer Services','Real Estate Investment Trusts'),
    ...
    ('LOMA','Loma Negra Compania Industrial Argentina Sociedad ','Capital Goods','Building Materials'),
    ...
    ('MCB','Metropolitan Bank Holding Corp.','n/a','n/a'),
    ...
    ('NP','Neenah Paper Inc.','Basic Industries','Paper'),
    ...
    ('NTL','Nortel Inversora SA','Public Utilities','Telecommunications Equipment'),
    ...
    ('OME','Omega Protein Corporation','Consumer Non-Durables','Packaged Foods'),
    ...
    ('PN','Patriot National Inc.','Finance','Specialty Insurers'),
    ...
    ('PEP','Pepsico Inc.','Consumer Non-Durables','Beverages (Production/Distribution)'),
    ...
    ('PMC','Pharmerica Corporation','Health Care','Medical/Nursing Services'),
    ...
    ('POT','Potash Corporation of Saskatchewan Inc.','Basic Industries','Agricultural Chemicals'),
    ...
    ('PFG','Principal Financial Group Inc','Finance','Accident &Health Insurance'),
    ...
    ('Q','Quintiles IMS Holdings Inc.','Health Care','Biotechnology: Commercial Physical & Biological Resarch'),
    ...
    ('RPAI^A.CL','Retail Properties of America Inc.','n/a','n/a'),
    ...
    ('RICE','Rice Energy Inc.','Energy','Oil & Gas Production'),
    ('RMP','Rice Midstream Partners LP','Public Utilities','Natural Gas Distribution'),
    ('RIC','Richmont Mines Inc.','Basic Industries','Precious Metals'),
    ...
    ('RY^S.CL','Royal Bank Of Canada','n/a','n/a'),
    ...
    ('RT','Ruby Tuesday Inc.','Consumer Services','Restaurants'),
    ...
    ('SAFE','Safety Income and Growth Inc.','Consumer Services','Real Estate'),
    ...
    ('SSNI','Silver Spring Networks Inc.','Technology','Computer Communications Equipment'),
    ...
    ('SWNC','Southwestern Energy Company','Energy','Oil & Gas Production'),
    ...
    ('SFR','Starwood Waypoint Homes','Consumer Services','Real Estate Investment Trusts'),
    ...
    ('SPLP^T','Steel Partners Holdings LP','n/a','n/a'),
    ...
    ('INN^B.CL','Summit Hotel Properties Inc.','n/a','n/a'),
    ...
    ('SYT','Syngenta AG','Basic Industries','Agricultural Chemicals'),
    ...
    ('TCF^C','TCF Financial Corporation','n/a','n/a'),
    ...
    ('SCHW^B.CL','The Charles Schwab Corporation','n/a','n/a'),
    ...
    ('TIME','Time Inc.','Consumer Services','Newspapers/Magazines'),
    ...
    ('TKF','Turkish Investment Fund Inc. (The)','n/a','n/a'),
    ...
    ('VNTV','Vantiv Inc.','Miscellaneous','Business Services'),
    ...
    ('VC','Visteon Corporation','Capital Goods','Auto Parts:O.E.M.'),
    ...
    ('WMT','Wal-Mart Stores Inc.','Consumer Services','Department/Specialty Retail Stores'),
    ...
    ('XEL','Xcel Energy Inc.','Public Utilities','Power Generation'),
    ...
    ('YUME','YuMe Inc.','Technology','Advertising'),
